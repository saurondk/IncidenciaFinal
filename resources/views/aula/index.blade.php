                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('aulas.destroy',$aula->id) }}" method="POST">
                                                    <a class="btn  btn-primary " href="{{ route('aulas.show',$aula->id) }}"><i class="fa fa-fw fa-eye"></i>Ver</a>
                                                    <a class="btn  btn-primary" href="{{ route('aulas.edit',$aula->id) }}"><i class="fa fa-fw fa-edit"></i>Editar</a>
                                                    @csrf
                                                    @method('DELETE')
